...
echo "<lang=\"$basename\">" > "./itrameur_deux_mots/$folder-$basename.txt" #On commence à créer la structure XML dans le fichier de sortie avec une valeur de balise lang égale à basename.
